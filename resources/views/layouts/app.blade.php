...
<body class="h-screen flex flex-col overflow-hidden">
        ...
        <div id="mainHeader" class="h-16 flex items-center px-3 bg-gray-50">
            ...
            <div class="flex flex-row items-center gap-2 ">
                ...
                <div class="relative  " x-data="userDropdown()" x-cloak>
                    ...
                    @else
                        <div class="cursor-pointer text-white rounded-full h-10 w-10 bg-center bg-cover flex justify-center items-center select-none"
                            style="background-image: url('{{ $user->avatar }}')" @click="toggle()">
                        </div>
                    @endif
                    ...
                    <div x-show="show" x-transition.origin.top.right @click.outside="close()"
                        ...
                        <div class="bg-white shadow-lg rounded-xl p-4">
                            ...
                            <div class="flex justify-center mt-3">
                                ...
                                @else
                                    <div class="text-white text-xl rounded-full h-16 w-16 flex items-center justify-center bg-center bg-cover"
    ...
    <div class="flex-1 flex min-h-0 overflow-hidden">
        ...
        <div id="sidebar" :class="{ 'hover': sidebarOpen, 'no-transition': noTransition }"
            class="hidden md:flex flex-col justify-start items-center pt-3 pb-2 bg-gray-50 px-4 gap-y-6 w-16 hover:w-56 not-hover:duration-1000 duration-600 not-hover:w-16 ease-in-out group min-h-screen"
            x-cloak>
        ...
        <div class="flex flex-col flex-1 min-h-0 overflow-hidden">
            ...
            <div id="main-content" class="flex-1 overflow-y-auto px-0.5 mt-3 mb-3 md:mt-0">
                <div class="fixed bottom-5 right-5 z-50 flex flex-col-reverse gap-2 w-80">
                    <x-toast />
                </div>
